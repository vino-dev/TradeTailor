...
public class FinancialStatementsQuarter {
	...
	public FinancialStatementsQuarter() {
		super();
	}
	public FinancialStatementsQuarter(List<Map<String, String>> income, List<Map<String, String>> balanceSheet,
